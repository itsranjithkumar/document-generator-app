...
const documentCards = [
  ...
  },
  {
    ...
    href: '/document-generator/offer-letter',
  },
  {
    icon: <FileText className="w-8 h-8" />,
    title: 'Relieving Letter',
    description: 'Generate relieving letters for departing employees',
    href: '/document-generator/relieving-letter',
  },
];
    ...
    <main className="min-h-screen bg-white text-foreground">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground text-balance leading-relaxed mb-10">
            Create professional certificates and employee documents in
            seconds. Beautiful templates, instant PDF downloads, and complete
            customization.
          </p>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">
              Access and manage your payment slips and receipts online
            </p>
      ...
      >
        <div className="mb-16">
          ...
          <p className="text-muted-foreground">
            Everything you need for professional document generation
          </p>
        </div>
          ...
          {[
            {
              ...
              description:
                'Generate documents in seconds with our intuitive interface',
            },
            {
              title: 'Instant PDF Export',
              description:
                'Download professionally formatted PDFs ready to share',
            },
            {
              title: 'Professional Quality',
              description:
                'Premium templates with perfect formatting',
            },
            {
              title: 'Custom Branding',
              description:
                'Add your logo, signature, and company details',
            },
            {
              title: 'Multiple Templates',
              description:
                'Certificates and employee document templates',
            },
            {
              title: 'Easy to Use',
              description:
                'No technical skills required, just fill and generate',
            },
          ].map((feature, index) => (
            <div key={index}>

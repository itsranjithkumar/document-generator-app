...
const SelectField = memo(({
  ...
  label: string; name: keyof FormState; options: Array<{ value: string; label: string }>; value: string; onChange: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => void;
}) => (
  <div>
    <label className="block text-xs font-semibold text-gray-500 mb-1.5 tracking-widest uppercase">
      {label}
    ...
    <select
      ...
      value={value}
      onChange={onChange}
      className="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
    >
      {options.map((opt) => (
...
const SAMPLE_DATA = {
  ...
  employeeName: "Mr. Arjun Krishnamurthy",
  employeeId: "EMP-2024-0047",
  designation: "Senior Software Engineer",
  department: "Technology & Product",
  dateOfJoining: "2020-07-15",
  lastWorkingDay: "2024-06-28",
  letterDate: "2024-06-28",
  letterRef: "HR/RL/2024/047",
  hrName: "Mrs. Priya Sharma",
  hrDesignation: "Head of Human Resources",
  relievingReason: "resignation",
  additionalNotes: "The employee has maintained excellent professional standards throughout their tenure.",
};

export default function RelievingLetterForm() {
  ...
  const handlePreview = () => {
    const snapshot = { ...form };
    localStorage.setItem("relievingLetterData", JSON.stringify(snapshot));
    router.push("/document-generator/relieving-letter/preview");
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-gray-900">Relieving Letter Generator</h1>
            <p className="text-xs text-gray-400 mt-0.5">Fill in employee details to generate a professional relieving letter</p>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Field label="Reference Number" name="letterRef" placeholder="HR/RL/2024/001" value={form.letterRef} onChange={handleChange} />
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Field label="Employee Full Name" name="employeeName" placeholder="Mr. Rajesh Kumar" full value={form.employeeName} onChange={handleChange} />
            <Field label="Employee ID" name="employeeId" placeholder="EMP-2024-001" value={form.employeeId} onChange={handleChange} />
            <Field label="Designation" name="designation" placeholder="Software Engineer" value={form.designation} onChange={handleChange} />
            ...
            <Field label="Last Working Day" name="lastWorkingDay" type="date" value={form.lastWorkingDay} onChange={handleChange} />
          </div>
        </div>

        {/* Separation Details */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <SectionTitle>Separation Details</SectionTitle>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <SelectField
              ...
              options={[
                ...
                { value: "end_of_contract", label: "Completion of Employment Contract" },
